...
public class addtpass implements ActionListener{
    ...
    JTextField t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12;
     ...
     public addtpass(){
        ...
        lb1=new JLabel("Tourist  Pass  Details");
        ...
        bt1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int i=Addtpassdata.save(idno,passno,name,price,issuedate,validupto,dob,age,source,destination,address,institute);
                if(i>0){
                    JOptionPane.showMessageDialog(null,"Tourist Pass Details Added Successfully");
                }else{
    ...
    public static void main(String[] string) {
        addtpass Addtpass=new addtpass(); 
    }
