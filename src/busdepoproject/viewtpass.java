...
class viewtpass extends JFrame{
	...
	public viewtpass() {
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select * from touristpass",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
