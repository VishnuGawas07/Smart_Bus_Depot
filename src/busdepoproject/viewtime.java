...
public class viewtime extends JFrame {
   private JPanel contentPane;
	...
	public viewtime() {
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select * from bustiming",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
