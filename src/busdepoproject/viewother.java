...
class viewother extends JFrame{
	...
	public viewother() {
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("select * from otherstaff",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
